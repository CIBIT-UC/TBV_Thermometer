classdef Logger < handle
   %LOGGER Abstract Class for Singleton OOP Design Pattern
   ...
   methods % Public Access
      ...
      function loggedData = getLoggedData(obj)
         loggedData = obj.loggedData;
      end
      ...
      % Output:
      %   <none>
      function addToLog(obj, loggedData)
         obj.loggedData = sprintf('%s%s\n', obj.loggedData, loggedData);
      end
